...
class DifenInfo extends StatefulWidget {
  const DifenInfo({super.key});

  @override
  State<DifenInfo> createState() => _DifenInfoState();
}

class _DifenInfoState extends State<DifenInfo> {
  @override
  void initState() {
    super.initState();
