...
class FicusInfo extends StatefulWidget {
  const FicusInfo({super.key});

  @override
  State<FicusInfo> createState() => _FicusInfoState();
}

class _FicusInfoState extends State<FicusInfo> {
  @override
  void initState() {
    super.initState();
