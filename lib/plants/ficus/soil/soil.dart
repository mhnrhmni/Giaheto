...
class FicusSoil extends StatefulWidget {
  const FicusSoil({super.key});

  @override
  State<FicusSoil> createState() => _FicusSoilState();
}

class _FicusSoilState extends State<FicusSoil> {
  @override
  void initState() {
    super.initState();
