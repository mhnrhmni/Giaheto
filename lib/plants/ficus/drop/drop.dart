...
class FicusDrop extends StatefulWidget {
  const FicusDrop({super.key});

  @override
  State<FicusDrop> createState() => _FicusDropState();
}

class _FicusDropState extends State<FicusDrop> {
  @override
  void initState() {
    super.initState();
